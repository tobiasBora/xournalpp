 ...
 * - a list of tuple containing for each element the element it self, and optionally (when type == all) its page and
 ...
 * When called with "page" to retrieve all elements on the current page, it also adds a field "layer" containing the
 ...
 *     page = 1.0, -- Only present when called with the "all" argument
 *     layer = 1.0, -- Only present when called with the "all" or "page" argument
 *   },
 *   {
 *     text = "Testing",
 *     font = {
 ...
 * stack. When called with "page" to retrieve all elements on the current page, it also adds a field "layer" containing
 ...
 *             ["page"] = 1.0, -- Only present when called with "all"
 *             ["layer"] = 1.0, -- Only present when called with "all" or "page"
 *         },
 *         {
